...
HARDWARE_M32                 = m32
###                           |---HW-spec-handy-ruler-----------------------|
M32_SPEC                     = x86_32 micro Linux
M32_USE_BUILT_GCC_LIBS       = no

####### x86_64 micro Linux:
HARDWARE_M64                 = m64
###                           |---HW-spec-handy-ruler-----------------------|
M64_SPEC                     = x86_64 micro Linux
M64_USE_BUILT_GCC_LIBS       = no
...
I686_GLIBC_HARDWARE_VARIANTS := $(HARDWARE_PC32) $(HARDWARE_M32)
...
X86_64_GLIBC_HARDWARE_VARIANTS := $(HARDWARE_PC64) $(HARDWARE_M64)
